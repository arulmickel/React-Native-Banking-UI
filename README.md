...
| Account Summary | Transactions | Transfer Flow |
|:-:|:-:|:-:|
| Dashboard with total balance and account cards | Filterable transaction history | Multi-step transfer with validation |
